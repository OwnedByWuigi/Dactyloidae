...
// Returns true when a registered DirectShow filter advertises H.264/AVC
// decoding. This works on Windows 2000 because it uses the legacy filter
// enumerator instead of Media Foundation.
bool
